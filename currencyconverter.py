...
class CurrencyConverter:  # Create class
    def __init__(self):  # Special method in Python class
        ...
        Label(window,font="Helvetica 12 bold",bg="gray",text ="Amount to convert").grid(row=1, column=1,sticky =W)
        Label(window,font="Helvetica 12 bold",bg="gray",text ="Conversion Rate").grid(row=2, column=1,sticky =W)
        Label(window,font="Helvetica 12 bold",bg="gray",text ="Converted Amount").grid(row=3, column=1,sticky =W)
        ...
        lblConvertedAmount =Label(window,font="Helvetica 12 bold",bg="gray", textvariable = self.convertedAmountVar).grid(row=3,column=2,sticky = E)
