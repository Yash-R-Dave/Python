...
os.chdir(directory)
songlist = os.listdir()
playlist = tkr.Listbox(musicplayer, font ="Helvetica 12 bold", bg="white",selectmode= tkr.SINGLE)
...
Button1 = tkr.Button(musicplayer,width=3,height=3, font="Helvetica 12 bold",text="PLAY",command=play,bg="red",fg="white")
